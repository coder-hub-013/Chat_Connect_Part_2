...
export default function AddNewUserInGroup({userId,id,handleCancleAddNewUserINGrop}) {
    ...
    useEffect(() => {
        let fetchUsers = async () => {
            const response = await fetch(`${url}/router/addUserInGroupDetails`, {
                method : "POST",
                headers : {
    ...
    return(
        <div>
            ...
            <div className="search-email">
                ...
                <button onClick={handleAddInGroup} disabled={selectedMembers.length === 0}>Add in group</button>
